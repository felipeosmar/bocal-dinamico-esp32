...
esp_err_t web_server_init(const web_server_config_t *config)
{
    ...
    httpd_uri_t rs485_config_get = { .uri = "/api/rs485/config", .method = HTTP_GET, .handler = api_rs485_config_handler };
    httpd_uri_t rs485_config_post = { .uri = "/api/rs485/config", .method = HTTP_POST, .handler = api_rs485_config_handler };
    httpd_uri_t rs485_diag = { .uri = "/api/rs485/diag", .method = HTTP_GET, .handler = api_rs485_diag_handler };
    httpd_uri_t rs485_test = { .uri = "/api/rs485/test", .method = HTTP_POST, .handler = api_rs485_test_handler };
    httpd_uri_t rs485_reset = { .uri = "/api/rs485/reset_stats", .method = HTTP_POST, .handler = api_rs485_reset_stats_handler };
    ...
    httpd_uri_t act_status = { .uri = "/api/actuator/status", .method = HTTP_GET, .handler = api_actuator_status_handler };
    httpd_uri_t act_control = { .uri = "/api/actuator/control", .method = HTTP_POST, .handler = api_actuator_control_handler };
    httpd_uri_t act_scan = { .uri = "/api/actuator/scan", .method = HTTP_GET, .handler = api_actuator_scan_handler };
    httpd_uri_t act_add = { .uri = "/api/actuator/add", .method = HTTP_POST, .handler = api_actuator_add_handler };
    httpd_uri_t act_remove = { .uri = "/api/actuator/remove", .method = HTTP_POST, .handler = api_actuator_remove_handler };
    httpd_uri_t act_set_name = { .uri = "/api/actuator/set-name", .method = HTTP_POST, .handler = api_actuator_set_name_handler };
    httpd_uri_t act_config_get = { .uri = "/api/actuator/config", .method = HTTP_GET, .handler = api_actuator_config_get_handler };
